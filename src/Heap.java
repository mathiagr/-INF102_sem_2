...
public class Heap {
    ...
    public static void main(String[] args) {
        ...
        int[] stringLengths = new int[]{2, 10, 20, 40, 50};

        for(int m = 0; m < stringLengths.length; m++){

            int keyLength = stringLengths[m]; //String lengths
            int keys = 10000; //Number of keys
            String alphabet = "abcdefghijklmnopqrstuvwxyz"; //Alphabeth from which we generate the keys
    ...
    //Generating a string of 10000 random strings of various length
            ...
            int N = 200; //number of runs to take average of
            int warmUpRuns = 100;
            double totalTime = 0;
